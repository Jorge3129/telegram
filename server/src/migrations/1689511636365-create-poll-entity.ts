...
export class CreatePollEntity1689511636365 implements MigrationInterface {
  name = 'CreatePollEntity1689511636365';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "poll_votes" ("userId" integer NOT NULL, "answerOptionId" uuid NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_28accea801e5f21f4e5b3ae5c17" PRIMARY KEY ("userId", "answerOptionId"))`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "poll_votes" ADD CONSTRAINT "FK_0281387f2c63687277cd175c4f4" FOREIGN KEY ("userId") REFERENCES "users"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
